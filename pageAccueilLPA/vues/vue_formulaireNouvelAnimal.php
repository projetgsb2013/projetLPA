...
<html>
	...
	<form method='POST' action='index.php?uc=gererAnimal&action=ajouterNouvelAnimal'>
	
    <label for="espece">Saisir l'espèce :</label>
	<input id="Espece" name="espece" type="text" placeholder="Espece" /><br><br>
	...
	<select id="sexe" name="sexe">
		...
		<option value="femmelle">Femmelle</option>
	</select>	
	<br><br>
	
	<label for="etat">Saisir s'il est castré ou non :</label>
    <input id="Etat" name="sexe" type="text" placeholder="etat" /><br><br>
